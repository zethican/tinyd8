export async function RollTest({
    ...
    let renderedRoll = await renderTemplate("systems/tinyd8/templates/partials/test-result.hbs", { rollResult: result });
    // let renderedRoll = await result.render({ result: result, template: "systems/tinyd8/templates/partials/test-result.hbs" });
